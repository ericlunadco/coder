...
type Stats struct {
	...
	ConnectionsByProto map[string]int64 `protobuf:"bytes,1,rep,name=connections_by_proto,json=connectionsByProto,proto3" json:"connections_by_proto,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
const file_agent_proto_agent_proto_rawDesc = "" +
	"\n" +
	"\x17agent/proto/agent.proto\x12\x0ecoder.agent.v2\x1a\x1btailnet/proto/tailnet.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xa6\x06\n" +
	...
	"\tsubdomain\x18\b \x01(\bR\tsubdomain\x12%\n" +
	"\x0esubdomain_name\x18\t \x01(\tR\rsubdomainName\x12N\n" +
	"\rsharing_level\x18\n" +
	" \x01(\x0e2).coder.agent.v2.WorkspaceApp.SharingLevelR\fsharingLevel\x12J\n" +
	"\vhealthcheck\x18\v \x01(\v2(.coder.agent.v2.WorkspaceApp.HealthcheckR\vhealthcheck\x12;\n" +
	"\x06health\x18\f \x01(\x0e2#.coder.agent.v2.WorkspaceApp.HealthR\x06health\x12\x16\n" +
	"\x06hidden\x18\r \x01(\bR\x06hidden\x1at\n" +
	"\vHealthcheck\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x125\n" +
	"\binterval\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\binterval\x12\x1c\n" +
	"\tthreshold\x18\x03 \x01(\x05R\tthreshold\"i\n" +
	"\fSharingLevel\x12\x1d\n" +
	"\x19SHARING_LEVEL_UNSPECIFIED\x10\x00\x12\t\n" +
	"\x05OWNER\x10\x01\x12\x11\n" +
	"\rAUTHENTICATED\x10\x02\x12\n" +
	"\n" +
	"\x06PUBLIC\x10\x03\x12\x10\n" +
	"\fORGANIZATION\x10\x04\"\\\n" +
	"\x06Health\x12\x16\n" +
	"\x12HEALTH_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\x10\n" +
	"\fINITIALIZING\x10\x02\x12\v\n" +
	"\aHEALTHY\x10\x03\x12\r\n" +
	"\tUNHEALTHY\x10\x04\"\xd9\x02\n" +
	"\x14WorkspaceAgentScript\x12\"\n" +
	"\rlog_source_id\x18\x01 \x01(\fR\vlogSourceId\x12\x19\n" +
	"\blog_path\x18\x02 \x01(\tR\alogPath\x12\x16\n" +
	"\x06script\x18\x03 \x01(\tR\x06script\x12\x12\n" +
	"\x04cron\x18\x04 \x01(\tR\x04cron\x12 \n" +
	"\frun_on_start\x18\x05 \x01(\bR\n" +
	"runOnStart\x12\x1e\n" +
	"\vrun_on_stop\x18\x06 \x01(\bR\trunOnStop\x12,\n" +
	"\x12start_blocks_login\x18\a \x01(\bR\x10startBlocksLogin\x123\n" +
	"\atimeout\x18\b \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12!\n" +
	"\fdisplay_name\x18\t \x01(\tR\vdisplayName\x12\x0e\n" +
	"\x02id\x18\n" +
	" \x01(\fR\x02id\"\x86\x04\n" +
	"\x16WorkspaceAgentMetadata\x12E\n" +
	"\x06result\x18\x01 \x01(\v2-.coder.agent.v2.WorkspaceAgentMetadata.ResultR\x06result\x12T\n" +
	"\vdescription\x18\x02 \x01(\v22.coder.agent.v2.WorkspaceAgentMetadata.DescriptionR\vdescription\x1a\x85\x01\n" +
	"\x06Result\x12=\n" +
	"\fcollected_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcollectedAt\x12\x10\n" +
	"\x03age\x18\x02 \x01(\x03R\x03age\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\x1a\xc6\x01\n" +
	"\vDescription\x12!\n" +
	...
	"\n" +
	"agent_name\x18\x0f \x01(\tR\tagentName\x12%\n" +
	"\x0eowner_username\x18\r \x01(\tR\rownerUsername\x12!\n" +
	"\fworkspace_id\x18\x0e \x01(\fR\vworkspaceId\x12%\n" +
	"\x0eworkspace_name\x18\x10 \x01(\tR\rworkspaceName\x12(\n" +
	"\x10git_auth_configs\x18\x02 \x01(\rR\x0egitAuthConfigs\x12g\n" +
	"\x15environment_variables\x18\x03 \x03(\v22.coder.agent.v2.Manifest.EnvironmentVariablesEntryR\x14environmentVariables\x12\x1c\n" +
	"\tdirectory\x18\x04 \x01(\tR\tdirectory\x122\n" +
	"\x16vs_code_port_proxy_uri\x18\x05 \x01(\tR\x12vsCodePortProxyUri\x12\x1b\n" +
	"\tmotd_path\x18\x06 \x01(\tR\bmotdPath\x12<\n" +
	"\x1adisable_direct_connections\x18\a \x01(\bR\x18disableDirectConnections\x122\n" +
	"\x15derp_force_websockets\x18\b \x01(\bR\x13derpForceWebsockets\x12 \n" +
	"\tparent_id\x18\x12 \x01(\fH\x00R\bparentId\x88\x01\x01\x124\n" +
	"\bderp_map\x18\t \x01(\v2\x19.coder.tailnet.v2.DERPMapR\aderpMap\x12>\n" +
	"\ascripts\x18\n" +
	...
	"configPath\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\"\x14\n" +
	"\x12GetManifestRequest\"n\n" +
	"\rServiceBanner\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12)\n" +
	"\x10background_color\x18\x03 \x01(\tR\x0fbackgroundColor\"\x19\n" +
	"\x17GetServiceBannerRequest\"\xb3\a\n" +
	"\x05Stats\x12_\n" +
	"\x14connections_by_proto\x18\x01 \x03(\v2-.coder.agent.v2.Stats.ConnectionsByProtoEntryR\x12connectionsByProto\x12)\n" +
	"\x10connection_count\x18\x02 \x01(\x03R\x0fconnectionCount\x12?\n" +
	"\x1cconnection_median_latency_ms\x18\x03 \x01(\x01R\x19connectionMedianLatencyMs\x12\x1d\n" +
	"\n" +
	"rx_packets\x18\x04 \x01(\x03R\trxPackets\x12\x19\n" +
	"\brx_bytes\x18\x05 \x01(\x03R\arxBytes\x12\x1d\n" +
	"\n" +
	"tx_packets\x18\x06 \x01(\x03R\ttxPackets\x12\x19\n" +
	"\btx_bytes\x18\a \x01(\x03R\atxBytes\x120\n" +
	"\x14session_count_vscode\x18\b \x01(\x03R\x12sessionCountVscode\x126\n" +
	"\x17session_count_jetbrains\x18\t \x01(\x03R\x15sessionCountJetbrains\x12C\n" +
	"\x1esession_count_reconnecting_pty\x18\n" +
	" \x01(\x03R\x1bsessionCountReconnectingPty\x12*\n" +
	"\x11session_count_ssh\x18\v \x01(\x03R\x0fsessionCountSsh\x126\n" +
	"\ametrics\x18\f \x03(\v2\x1c.coder.agent.v2.Stats.MetricR\ametrics\x1aE\n" +
	"\x17ConnectionsByProtoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a\x8e\x02\n" +
	"\x06Metric\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x125\n" +
	"\x04type\x18\x02 \x01(\x0e2!.coder.agent.v2.Stats.Metric.TypeR\x04type\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x01R\x05value\x12:\n" +
	"\x06labels\x18\x04 \x03(\v2\".coder.agent.v2.Stats.Metric.LabelR\x06labels\x1a1\n" +
	"\x05Label\x12\x12\n" +
	...
	"\x05GAUGE\x10\x02\"A\n" +
	"\x12UpdateStatsRequest\x12+\n" +
	"\x05stats\x18\x01 \x01(\v2\x15.coder.agent.v2.StatsR\x05stats\"Y\n" +
	"\x13UpdateStatsResponse\x12B\n" +
	"\x0freport_interval\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\x0ereportInterval\"\xae\x02\n" +
	"\tLifecycle\x125\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1f.coder.agent.v2.Lifecycle.StateR\x05state\x129\n" +
	"\n" +
	"changed_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tchangedAt\"\xae\x01\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aCREATED\x10\x01\x12\f\n" +
	"\bSTARTING\x10\x02\x12\x11\n" +
	"\rSTART_TIMEOUT\x10\x03\x12\x0f\n" +
	"\vSTART_ERROR\x10\x04\x12\t\n" +
	"\x05READY\x10\x05\x12\x11\n" +
	"\rSHUTTING_DOWN\x10\x06\x12\x14\n" +
	"\x10SHUTDOWN_TIMEOUT\x10\a\x12\x12\n" +
	"\x0eSHUTDOWN_ERROR\x10\b\x12\a\n" +
	"\x03OFF\x10\t\"Q\n" +
	"\x16UpdateLifecycleRequest\x127\n" +
	"\tlifecycle\x18\x01 \x01(\v2\x19.coder.agent.v2.LifecycleR\tlifecycle\"\xc4\x01\n" +
	"\x1bBatchUpdateAppHealthRequest\x12R\n" +
	"\aupdates\x18\x01 \x03(\v28.coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdateR\aupdates\x1aQ\n" +
	"\fHealthUpdate\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\x121\n" +
	"\x06health\x18\x02 \x01(\x0e2\x19.coder.agent.v2.AppHealthR\x06health\"\x1e\n" +
	"\x1cBatchUpdateAppHealthResponse\"\xe8\x01\n" +
	"\aStartup\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12-\n" +
	"\x12expanded_directory\x18\x02 \x01(\tR\x11expandedDirectory\x12A\n" +
	"\n" +
	"subsystems\x18\x03 \x03(\x0e2!.coder.agent.v2.Startup.SubsystemR\n" +
	"subsystems\"Q\n" +
	"\tSubsystem\x12\x19\n" +
	"\x15SUBSYSTEM_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06ENVBOX\x10\x01\x12\x0e\n" +
	"\n" +
	"ENVBUILDER\x10\x02\x12\r\n" +
	"\tEXECTRACE\x10\x03\"I\n" +
	"\x14UpdateStartupRequest\x121\n" +
	"\astartup\x18\x01 \x01(\v2\x17.coder.agent.v2.StartupR\astartup\"c\n" +
	"\bMetadata\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12E\n" +
	"\x06result\x18\x02 \x01(\v2-.coder.agent.v2.WorkspaceAgentMetadata.ResultR\x06result\"R\n" +
	"\x1aBatchUpdateMetadataRequest\x124\n" +
	"\bmetadata\x18\x02 \x03(\v2\x18.coder.agent.v2.MetadataR\bmetadata\"\x1d\n" +
	"\x1bBatchUpdateMetadataResponse\"\xde\x01\n" +
	"\x03Log\x129\n" +
	"\n" +
	"created_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12\x16\n" +
	"\x06output\x18\x02 \x01(\tR\x06output\x12/\n" +
	"\x05level\x18\x03 \x01(\x0e2\x19.coder.agent.v2.Log.LevelR\x05level\"S\n" +
	"\x05Level\x12\x15\n" +
	...
	"\rlog_source_id\x18\x01 \x01(\fR\vlogSourceId\x12'\n" +
	"\x04logs\x18\x02 \x03(\v2\x13.coder.agent.v2.LogR\x04logs\"G\n" +
	"\x17BatchCreateLogsResponse\x12,\n" +
	"\x12log_limit_exceeded\x18\x01 \x01(\bR\x10logLimitExceeded\"\x1f\n" +
	"\x1dGetAnnouncementBannersRequest\"q\n" +
	"\x1eGetAnnouncementBannersResponse\x12O\n" +
	"\x14announcement_banners\x18\x01 \x03(\v2\x1c.coder.agent.v2.BannerConfigR\x13announcementBanners\"m\n" +
	"\fBannerConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12)\n" +
	"\x10background_color\x18\x03 \x01(\tR\x0fbackgroundColor\"V\n" +
	"$WorkspaceAgentScriptCompletedRequest\x12.\n" +
	"\x06timing\x18\x01 \x01(\v2\x16.coder.agent.v2.TimingR\x06timing\"'\n" +
	"%WorkspaceAgentScriptCompletedResponse\"\xfd\x02\n" +
	"\x06Timing\x12\x1b\n" +
	"\tscript_id\x18\x01 \x01(\fR\bscriptId\x120\n" +
	...
	"\texit_code\x18\x04 \x01(\x05R\bexitCode\x122\n" +
	"\x05stage\x18\x05 \x01(\x0e2\x1c.coder.agent.v2.Timing.StageR\x05stage\x125\n" +
	"\x06status\x18\x06 \x01(\x0e2\x1d.coder.agent.v2.Timing.StatusR\x06status\"&\n" +
	"\x05Stage\x12\t\n" +
	...
	"\fEXIT_FAILURE\x10\x01\x12\r\n" +
	"\tTIMED_OUT\x10\x02\x12\x13\n" +
	"\x0fPIPES_LEFT_OPEN\x10\x03\",\n" +
	"*GetResourcesMonitoringConfigurationRequest\"\xa0\x04\n" +
	"+GetResourcesMonitoringConfigurationResponse\x12Z\n" +
	"\x06config\x18\x01 \x01(\v2B.coder.agent.v2.GetResourcesMonitoringConfigurationResponse.ConfigR\x06config\x12_\n" +
	"\x06memory\x18\x02 \x01(\v2B.coder.agent.v2.GetResourcesMonitoringConfigurationResponse.MemoryH\x00R\x06memory\x88\x01\x01\x12\\\n" +
	"\avolumes\x18\x03 \x03(\v2B.coder.agent.v2.GetResourcesMonitoringConfigurationResponse.VolumeR\avolumes\x1ao\n" +
	"\x06Config\x12%\n" +
	"\x0enum_datapoints\x18\x01 \x01(\x05R\rnumDatapoints\x12>\n" +
	"\x1bcollection_interval_seconds\x18\x02 \x01(\x05R\x19collectionIntervalSeconds\x1a\"\n" +
	"\x06Memory\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x1a6\n" +
	"\x06Volume\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04pathB\t\n" +
	"\a_memory\"\xb3\x04\n" +
	"#PushResourcesMonitoringUsageRequest\x12]\n" +
	"\n" +
	"datapoints\x18\x01 \x03(\v2=.coder.agent.v2.PushResourcesMonitoringUsageRequest.DatapointR\n" +
	"datapoints\x1a\xac\x03\n" +
	"\tDatapoint\x12=\n" +
	"\fcollected_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcollectedAt\x12f\n" +
	"\x06memory\x18\x02 \x01(\v2I.coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsageH\x00R\x06memory\x88\x01\x01\x12c\n" +
	"\avolumes\x18\x03 \x03(\v2I.coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsageR\avolumes\x1a7\n" +
	"\vMemoryUsage\x12\x12\n" +
	"\x04used\x18\x01 \x01(\x03R\x04used\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x03R\x05total\x1aO\n" +
	"\vVolumeUsage\x12\x16\n" +
	"\x06volume\x18\x01 \x01(\tR\x06volume\x12\x12\n" +
	"\x04used\x18\x02 \x01(\x03R\x04used\x12\x14\n" +
	"\x05total\x18\x03 \x01(\x03R\x05totalB\t\n" +
	"\a_memory\"&\n" +
	"$PushResourcesMonitoringUsageResponse\"\xb6\x03\n" +
	"\n" +
	"Connection\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\x129\n" +
	"\x06action\x18\x02 \x01(\x0e2!.coder.agent.v2.Connection.ActionR\x06action\x123\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1f.coder.agent.v2.Connection.TypeR\x04type\x128\n" +
	...
	"statusCode\x12\x1b\n" +
	"\x06reason\x18\a \x01(\tH\x00R\x06reason\x88\x01\x01\"=\n" +
	"\x06Action\x12\x16\n" +
	"\x12ACTION_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aCONNECT\x10\x01\x12\x0e\n" +
	"\n" +
	"DISCONNECT\x10\x02\"V\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\a\n" +
	"\x03SSH\x10\x01\x12\n" +
	"\n" +
	"\x06VSCODE\x10\x02\x12\r\n" +
	"\tJETBRAINS\x10\x03\x12\x14\n" +
	"\x10RECONNECTING_PTY\x10\x04B\t\n" +
	"\a_reason\"U\n" +
	"\x17ReportConnectionRequest\x12:\n" +
	"\n" +
	"connection\x18\x01 \x01(\v2\x1a.coder.agent.v2.ConnectionR\n" +
	"connection\"M\n" +
	"\bSubAgent\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\fR\x02id\x12\x1d\n" +
	"\n" +
	"auth_token\x18\x03 \x01(\fR\tauthToken\"\x9d\n" +
	"\n" +
	"\x15CreateSubAgentRequest\x12\x12\n" +
	...
	"\x04apps\x18\x05 \x03(\v2).coder.agent.v2.CreateSubAgentRequest.AppR\x04apps\x12S\n" +
	"\fdisplay_apps\x18\x06 \x03(\x0e20.coder.agent.v2.CreateSubAgentRequest.DisplayAppR\vdisplayApps\x1a\x81\a\n" +
	"\x03App\x12\x12\n" +
	"\x04slug\x18\x01 \x01(\tR\x04slug\x12\x1d\n" +
	"\acommand\x18\x02 \x01(\tH\x00R\acommand\x88\x01\x01\x12&\n" +
	"\fdisplay_name\x18\x03 \x01(\tH\x01R\vdisplayName\x88\x01\x01\x12\x1f\n" +
	"\bexternal\x18\x04 \x01(\bH\x02R\bexternal\x88\x01\x01\x12\x19\n" +
	"\x05group\x18\x05 \x01(\tH\x03R\x05group\x88\x01\x01\x12\\\n" +
	"\vhealthcheck\x18\x06 \x01(\v25.coder.agent.v2.CreateSubAgentRequest.App.HealthcheckH\x04R\vhealthcheck\x88\x01\x01\x12\x1b\n" +
	"\x06hidden\x18\a \x01(\bH\x05R\x06hidden\x88\x01\x01\x12\x17\n" +
	"\x04icon\x18\b \x01(\tH\x06R\x04icon\x88\x01\x01\x12N\n" +
	"\aopen_in\x18\t \x01(\x0e20.coder.agent.v2.CreateSubAgentRequest.App.OpenInH\aR\x06openIn\x88\x01\x01\x12\x19\n" +
	"\x05order\x18\n" +
	" \x01(\x05H\bR\x05order\x88\x01\x01\x12Q\n" +
	"\x05share\x18\v \x01(\x0e26.coder.agent.v2.CreateSubAgentRequest.App.SharingLevelH\tR\x05share\x88\x01\x01\x12!\n" +
	"\tsubdomain\x18\f \x01(\bH\n" +
	"R\tsubdomain\x88\x01\x01\x12\x15\n" +
	"\x03url\x18\r \x01(\tH\vR\x03url\x88\x01\x01\x1aY\n" +
	"\vHealthcheck\x12\x1a\n" +
	"\binterval\x18\x01 \x01(\x05R\binterval\x12\x1c\n" +
	"\tthreshold\x18\x02 \x01(\x05R\tthreshold\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03url\"\"\n" +
	"\x06OpenIn\x12\x0f\n" +
	"\vSLIM_WINDOW\x10\x00\x12\a\n" +
	"\x03TAB\x10\x01\"J\n" +
	"\fSharingLevel\x12\t\n" +
	"\x05OWNER\x10\x00\x12\x11\n" +
	"\rAUTHENTICATED\x10\x01\x12\n" +
	"\n" +
	"\x06PUBLIC\x10\x02\x12\x10\n" +
	"\fORGANIZATION\x10\x03B\n" +
	"\n" +
	"\b_commandB\x0f\n" +
	"\r_display_nameB\v\n" +
	"\t_externalB\b\n" +
	...
	"DisplayApp\x12\n" +
	"\n" +
	"\x06VSCODE\x10\x00\x12\x13\n" +
	"\x0fVSCODE_INSIDERS\x10\x01\x12\x10\n" +
	"\fWEB_TERMINAL\x10\x02\x12\x0e\n" +
	"\n" +
	"SSH_HELPER\x10\x03\x12\x1a\n" +
	"\x16PORT_FORWARDING_HELPER\x10\x04\"\x96\x02\n" +
	"\x16CreateSubAgentResponse\x12.\n" +
	"\x05agent\x18\x01 \x01(\v2\x18.coder.agent.v2.SubAgentR\x05agent\x12g\n" +
	"\x13app_creation_errors\x18\x02 \x03(\v27.coder.agent.v2.CreateSubAgentResponse.AppCreationErrorR\x11appCreationErrors\x1ac\n" +
	"\x10AppCreationError\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x05R\x05index\x12\x19\n" +
	"\x05field\x18\x02 \x01(\tH\x00R\x05field\x88\x01\x01\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05errorB\b\n" +
	"\x06_field\"'\n" +
	"\x15DeleteSubAgentRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\"\x18\n" +
	"\x16DeleteSubAgentResponse\"\x16\n" +
	"\x14ListSubAgentsRequest\"I\n" +
	"\x15ListSubAgentsResponse\x120\n" +
	"\x06agents\x18\x01 \x03(\v2\x18.coder.agent.v2.SubAgentR\x06agents*c\n" +
	"\tAppHealth\x12\x1a\n" +
	"\x16APP_HEALTH_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\x10\n" +
	"\fINITIALIZING\x10\x02\x12\v\n" +
	"\aHEALTHY\x10\x03\x12\r\n" +
	"\tUNHEALTHY\x10\x042\x91\r\n" +
	"\x05Agent\x12K\n" +
	...
	"\vUpdateStats\x12\".coder.agent.v2.UpdateStatsRequest\x1a#.coder.agent.v2.UpdateStatsResponse\x12T\n" +
	"\x0fUpdateLifecycle\x12&.coder.agent.v2.UpdateLifecycleRequest\x1a\x19.coder.agent.v2.Lifecycle\x12r\n" +
	"\x15BatchUpdateAppHealths\x12+.coder.agent.v2.BatchUpdateAppHealthRequest\x1a,.coder.agent.v2.BatchUpdateAppHealthResponse\x12N\n" +
	"\rUpdateStartup\x12$.coder.agent.v2.UpdateStartupRequest\x1a\x17.coder.agent.v2.Startup\x12n\n" +
	"\x13BatchUpdateMetadata\x12*.coder.agent.v2.BatchUpdateMetadataRequest\x1a+.coder.agent.v2.BatchUpdateMetadataResponse\x12b\n" +
	"\x0fBatchCreateLogs\x12&.coder.agent.v2.BatchCreateLogsRequest\x1a'.coder.agent.v2.BatchCreateLogsResponse\x12w\n" +
	"\x16GetAnnouncementBanners\x12-.coder.agent.v2.GetAnnouncementBannersRequest\x1a..coder.agent.v2.GetAnnouncementBannersResponse\x12~\n" +
	"\x0fScriptCompleted\x124.coder.agent.v2.WorkspaceAgentScriptCompletedRequest\x1a5.coder.agent.v2.WorkspaceAgentScriptCompletedResponse\x12\x9e\x01\n" +
	"#GetResourcesMonitoringConfiguration\x12:.coder.agent.v2.GetResourcesMonitoringConfigurationRequest\x1a;.coder.agent.v2.GetResourcesMonitoringConfigurationResponse\x12\x89\x01\n" +
	"\x1cPushResourcesMonitoringUsage\x123.coder.agent.v2.PushResourcesMonitoringUsageRequest\x1a4.coder.agent.v2.PushResourcesMonitoringUsageResponse\x12S\n" +
	...
	"\rListSubAgents\x12$.coder.agent.v2.ListSubAgentsRequest\x1a%.coder.agent.v2.ListSubAgentsResponseB'Z%github.com/coder/coder/v2/agent/protob\x06proto3"
...
func file_agent_proto_agent_proto_init() {
	...
	file_agent_proto_agent_proto_msgTypes[53].OneofWrappers = []any{}
