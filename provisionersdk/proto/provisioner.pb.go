...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	...
	"\adefault\x18\x04 \x01(\bR\adefault\";\n" +
	...
	"configPath\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\xba\x03\n" +
	"\x03App\x12\x12\n" +
	...
	"\x06AITask\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12>\n" +
	"\vsidebar_app\x18\x02 \x01(\v2\x1d.provisioner.AITaskSidebarAppR\n" +
	"sidebarApp\"\xca\t\n" +
	"\bMetadata\x12\x1b\n" +
	...
	"\x19running_agent_auth_tokens\x18\x15 \x03(\v2\".provisioner.RunningAgentAuthTokenR\x16runningAgentAuthTokens\"\x8a\x01\n" +
	"\x06Config\x126\n" +
	...
	"\x11omit_module_files\x18\x06 \x01(\bR\x0fomitModuleFiles\"\x91\x05\n" +
	...
	"hasAiTasks\x12.\n" +
	"\bai_tasks\x18\x0e \x03(\v2\x13.provisioner.AITaskR\aaiTasks\"A\n" +
	"\fApplyRequest\x121\n" +
