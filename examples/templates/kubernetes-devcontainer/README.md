...
Provision Devcontainers as [Coder workspaces](https://docs.coder.buildworkforce.ai/workspaces) on Kubernetes with this example template.
...
Coder supports devcontainers with [envbuilder](https://github.com/coder/envbuilder), an open source project. Read more about this in [Coder's documentation](https://docs.coder.buildworkforce.ai/templates/dev-containers).
