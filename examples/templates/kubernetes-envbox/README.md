...
| `CODER_AGENT_TOKEN`        | The [Coder Agent](https://docs.coder.buildworkforce.ai/about/architecture#agents) token to pass to the inner container.                                                                                                                                                                                                                                                                                                                                                                       | True     |
...
Due to the [deprecation and removal of legacy parameters](https://docs.coder.buildworkforce.ai/templates/parameters#legacy)
it may be necessary to migrate existing envbox templates on newer versions of
Coder. Consult the [migration](https://docs.coder.buildworkforce.ai/templates/parameters#migration)
